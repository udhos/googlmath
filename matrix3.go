...
func XRotationMatrix3(angle float32) Matrix3 {
...
func YRotationMatrix3(angle float32) Matrix3 {
	angle = DegreeToRadians * angle
...
func ZRotationMatrix3(angle float32) Matrix3 {
	angle = DegreeToRadians * angle
...
func RotationMatrix3(axis Vector3, angle float32) Matrix3 {
	axis = axis.Nor()
	angle = DegreeToRadians * angle
...
func TranslationMatrix3(x, y float32) Matrix3 {
	return Matrix3{
		1, 0, 0,
		0, 1, 0,
		x, y, 1,
...
func ScaleMatrix3(scaleX, scaleY float32) Matrix3 {
	return Matrix3{
		scaleX, 0, 0,
		0, scaleY, 0,
		0, 0, 1,
...
func (m Matrix3) Inverse() (Matrix3, error) {
	det := m.Determinant()
	if det == 0 {
		return Matrix3{}, errors.New("Can't invert a singular matrix")
	}
