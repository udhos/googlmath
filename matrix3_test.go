...
func (s *S) TestIdentityMatrix3(c *C) {
	expected := Matrix3{
		1, 0, 0,
		0, 1, 0,
		0, 0, 1,
	}
	obtained := IdentityMatrix3()
	c.Check(obtained, Matrix3Check, expected)
}

func (s *S) TestXRotationMatrix3(c *C) {
	...
	for _, value := range tests {
		matrix := XRotationMatrix3(value.Value)
		c.Check(matrix, Matrix3Check, value.Expected)
	}
}

func (s *S) TestYRotationMatrix3(c *C) {
	tests := []FloatMatrix3TestValue{
		FloatMatrix3TestValue{
			-99,
	...
	for _, value := range tests {
		matrix := YRotationMatrix3(value.Value)
		c.Check(matrix, Matrix3Check, value.Expected)
	}
}

func (s *S) TestZRotationMatrix3(c *C) {
	tests := []FloatMatrix3TestValue{
		FloatMatrix3TestValue{
			-99,
	...
	for _, value := range tests {
		matrix := ZRotationMatrix3(value.Value)
		c.Check(matrix, Matrix3Check, value.Expected)
	}
}

func (s *S) TestRotationMatrix3(c *C) {
	...
	for _, value := range tests {
		matrix := RotationMatrix3(value.Vector, value.Value)
		c.Check(matrix, Matrix3Check, value.Expected)
	}
}

func (s *S) TestTranslationMatrix3(c *C) {
	...
	for _, value := range tests {
		matrix := TranslationMatrix3(value.Vector.X, value.Vector.Y)
		c.Check(matrix, Matrix3Check, value.Expected)
	}
}

func (s *S) TestScaleMatrix3(c *C) {
	tests := []Vector2Matrix3TestValue{
		Vector2Matrix3TestValue{
			Vec2(1.2, -2.0),
	...
	for _, value := range tests {
		matrix := ScaleMatrix3(value.Vector.X, value.Vector.Y)
		c.Check(matrix, Matrix3Check, value.Expected)
	}
}
